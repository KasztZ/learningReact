    ...
    return(
        <div>
            <main className="cards">
                <img src={props.imageURL} alt={props.imageAlt} className="cards--image"/>
                <section className="cards--content">
                    <section className="cards--header">
                        <svg width="7" height="10" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg" className="cards--svg">
                        ...
                        <p className="cards--location">{props.location}</p>
                        <a href={props.googleMaps} className="cards--googleMaps">View on Google Maps</a>
                    </section>
                    <section className="cards--mainContent">
                        <h1 className="cards--title">{props.title}</h1>
                        <p className="cards--dates">{`${props.startDate} - ${props.endDate}`}</p>
                        <p className="cards--description">{props.description}</p>
                    </section>
                </section>
            </main>
            <hr className="cards--separation"/>
        </div>
    )
}