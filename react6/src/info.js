...
export default function Info() {
    return (
        <div className="infoPart">
            <img src="photo.png" alt="selfie" className="person--picture"></img>
            <h1 className="person--name">Laura Smith</h1>
            <h2 className="person--job">Frontend Developer</h2>
            <h3 className="person--email">smith.laura@gmail.com</h3>
            <div className="buttons">
                <button className="buttons--information_email">
                ...
                <button className="buttons--information_linkedin">
